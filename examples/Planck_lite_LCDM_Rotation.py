...
from BOBE.transforms import NormalisingFlowTransform, RotationTransform
...
def main():
    ...
    likelihood_name = 'Planck_lite_LCDM_Rotation'

    start = time.time()
    print("Starting BOBE run with Rotation transform...")
    ...
    bobe = BOBE(
        ...
        # likelihood and calls RotationTransform(param_bounds, **kwargs).
        transform=(RotationTransform, {'kl_threshold': 0.5, 'max_updates': 5, 'update_step': 10}),
    )
