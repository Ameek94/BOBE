...
script with continuous GP parameter rotation applied to cosmological parameters
only.  CamSpec calibration parameters and the tensor-to-scalar ratio r are kept
...
All remaining sampled parameters (CamSpec nuisance, r) use linear scaling.
"""
...
# r and all CamSpec calibration parameters remain linear.
PLANCK_DESI_BK18_R_COSMO_PARAMS = ['omch2', 'ombh2', 'H0', 'logA', 'ns', 'tau']
...
def main():
    ...
    likelihood_name = f'Planck_DESI_BK18_r_Rotation_cosmo_continuous_adaptive_batch_{seed}'
    ...
    if results is not None:
        ...
        cosmo_params = ['r'] + PLANCK_DESI_BK18_R_COSMO_PARAMS
