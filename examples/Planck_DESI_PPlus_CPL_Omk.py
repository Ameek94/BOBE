...
sampler = BOBE(n_cobaya_init=32, n_sobol_init = 32, 
        miniters=1000, maxiters=5000,max_gp_size=1900,
        ...
        lengthscale_priors='DSLP',logz_threshold=10.,clf_threshold=350,gp_threshold=2000,
        use_clf=True,clf_type=clf,clf_use_size=75,clf_update_step=clf_update_step,minus_inf=-1e5,)
...
plot_params = ['w','wa','omk','omch2','ombh2','logA','ns','H0','tau']
